...
export const PrevIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M9.53 4.03a.75.75 0 00-1.06 0l-6 6a.75.75 0 000 1.06l6 6a.75.75 0 101.06-1.06L4.06 11.25H18a.75.75 0 000-1.5H4.06l5.47-5.47a.75.75 0 000-1.06z" clipRule="evenodd" />
  </svg>
);

export const NextIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M14.47 4.03a.75.75 0 011.06 0l6 6a.75.75 0 010 1.06l-6 6a.75.75 0 11-1.06-1.06L19.94 11.25H6a.75.75 0 010-1.5h13.94l-5.47-5.47a.75.75 0 010-1.06z" clipRule="evenodd" />
  </svg>
);

export const RepeatIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0112.548-3.364l1.903 1.903h-4.518a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h5.25a.75.75 0 00.75-.75v-5.25a.75.75 0 00-1.5 0v2.654a9 9 0 10-14.258 2.152.75.75 0 00.916.635 7.5 7.5 0 013.848-5.385z" clipRule="evenodd" />
  </svg>
);
...
export const AudioFileIcon: React.FC<{ className?: string }> = ({ className = 'w-10 h-10' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
